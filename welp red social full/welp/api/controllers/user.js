...
function saveUser(req, res){
	...
	if(params.name && params.surname && params.role && params.ayuda &&
	   params.nick && params.email && params.password && params.continente){
		...
		user.ayuda = params.ayuda;
		user.continente = params.continente;
		user.image = null;
